...
const Upcoming = () => {
  const { upcomingFetchDataSuccess } = useSelector((state) => state);
  return (
    <section class="text-gray-600 body-font">
    <div class="container px-5 mx-auto">
      <div class="flex flex-col text-center w-full">
        <h1 class="text-2xl font-medium title-font mb-4 text-gray-900">Upcoming Movies</h1>
      </div>
      <div class="grid grid-rows-1 grid-flow-col -m-4 overflow-x-auto">
      {upcomingFetchDataSuccess.map((item) =>
